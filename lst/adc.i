...
void  Adc_Init(void)
{
	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2ENR |= 1<<2 | 1<<9;	  
 
	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->CFGR |= 0x2<<14;    

	
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800))->CRL &= ~(0x3<<6);
	...
	((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))->CR2 |= 0x7<<17;		
  ...
  ((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))->CR2 |= 1<<0;		
	...
	while((((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))->CR2 & 1<<3) != 0);	
	
	((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))->CR2 |= 1<<2;	 
 
	while((((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))->CR2 & 1<<2) != 0);	 
...
u16 Get_Adc(u8 ch)   
{
	...
	((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))->SMPR2 |= 0xF<<(3*ch);
	((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))->SQR3 &= ~(0x1F<<0);
	((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))->SQR3 |= ch << 0;		
  
	((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))->CR2 |= 0x00500000;	
