...
extern void led_init()
{
	*((vu32*)(((vu32)(&((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2ENR)&0xF0000000)+0x2000000 +(((vu32)(&((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2ENR)&0xFFFFF)<<5) + (4<<2))) = 1;
	...
	config_gpio(0x0800, 0x00|0x03, 1<<0|1<<1|1<<2, PULL_UP);
	led_setR(LED_OFF);
	led_setG(LED_OFF);
	led_setB(LED_OFF);
...
{
	if(LED_ON == s){
		*((vu32*)(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xF0000000)+0x2000000 +(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xFFFFF)<<5) + (2<<2))) = VAL_0;
	} else {
		*((vu32*)(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xF0000000)+0x2000000 +(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xFFFFF)<<5) + (2<<2))) = VAL_1;
	}
}
extern void led_setG(LED_STAT s)
{
	if(LED_ON == s){
		*((vu32*)(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xF0000000)+0x2000000 +(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xFFFFF)<<5) + (1<<2))) = VAL_0;
	} else {
		*((vu32*)(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xF0000000)+0x2000000 +(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xFFFFF)<<5) + (1<<2))) = VAL_1;
	}
}
extern void led_setB(LED_STAT s)
{
	if(LED_ON == s){
		*((vu32*)(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xF0000000)+0x2000000 +(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xFFFFF)<<5) + (0<<2))) = VAL_0;
	} else {
		*((vu32*)(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xF0000000)+0x2000000 +(((vu32)(&((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR)&0xFFFFF)<<5) + (0<<2))) = VAL_1;
	}
}
extern void led_col(void)
{
	u8	i = 0;
	for(i=0; i<8; i++){
		set_PINxs(0x0800, 1<<0|1<<1|1<<2, VAL_1);
		set_PINxs(0x0800, i, VAL_0);
		_delay_ms(1000);
