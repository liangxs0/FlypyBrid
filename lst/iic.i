...
void IIC_Start(void)
{
	...
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->BSRR |= 1<<11;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->BSRR |= 1<<10;
	_delay_us(4);
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->BSRR |= 1<<27;
	_delay_us(4);
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->BSRR |= 1<<26;
}
...
u8	IIC_Read_Byte(u8 ack)
{
	...
	for(i = 0;i < 8;i++)
	{
		...
		((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->BSRR |= 1<<10;
		receive <<=1;
		if(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->IDR & 1<<11) receive++;
		_delay_us(1);
	}
	if(!ack)IIC_NAck();
	else IIC_Ack();
...
u8 IIC_Wait_Ack(void)
{
	...
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->BSRR |= 1<<10;
	_delay_us(1);
	while(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->IDR & 1<<11)
	{
		ucErrTime++;
		if(ucErrTime > 250)
		{
