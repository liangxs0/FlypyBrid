...
void USART1_IRQHandler(void)
{
	...
	{	
		...
		if(!(usart1.rx_stat&0x01))
		{
				usart1.rx_buf[usart1.rx_size] = res;
				usart1.rx_size++;
				usart1.rx_size = usart1.rx_size&0x00FF;
...
{
	s8	res;
	if(!(usart1.rx_stat&0x02))
	{
		res = usart1.rx_buf[usart1.rx_seek];
		usart1.rx_seek++;
		usart1.rx_seek = usart1.rx_seek&0x00FF;
		if(usart1.rx_size == usart1.rx_seek)
		{
			usart1.rx_stat |= 0x02;
		}
...
void usart1_init(u32 pclk2,u32 bound)
{
	...
	*((vu32*)(((vu32)(&((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2ENR)&0xF0000000)+0x2000000 +(((vu32)(&((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2ENR)&0xFFFFF)<<5) + (2<<2))) = 1;
	
	*((vu32*)(((vu32)(&((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2ENR)&0xF0000000)+0x2000000 +(((vu32)(&((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2ENR)&0xFFFFF)<<5) + (14<<2))) = 1;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800))->CRH &= 0xfffff00f;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800))->CRH |= 0xfffff8Bf;
	
	*((vu32*)(((vu32)(&((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2RSTR)&0xF0000000)+0x2000000 +(((vu32)(&((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2RSTR)&0xFFFFF)<<5) + (14<<2))) = 1;
	*((vu32*)(((vu32)(&((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2RSTR)&0xF0000000)+0x2000000 +(((vu32)(&((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2RSTR)&0xFFFFF)<<5) + (14<<2))) = 0;
	...
	*((vu32*)(((vu32)(&((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->CR1)&0xF0000000)+0x2000000 +(((vu32)(&((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->CR1)&0xFFFFF)<<5) + (8<<2))) = 1;		
	*((vu32*)(((vu32)(&((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->CR1)&0xF0000000)+0x2000000 +(((vu32)(&((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))->CR1)&0xFFFFF)<<5) + (5<<2))) = 1;		
	register_nvic(0, 10, 4, ((u8)0x25));
	nvic_set_enable(((u8)0x25));
