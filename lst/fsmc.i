...
void FSMC_SRAM_init(void)
{
	...
	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->APB2ENR |= 1<<5 | 1<<6 | 1<<7 | 1<<8;
	
	
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400))->CRH &= 0x00000000;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400))->CRH |= 0xBBBBBBBB;
	...
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1800))->CRL &= 0x0FFFFF00;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1800))->CRL |= 0xB00000BB;
	
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1C00))->CRH &= 0x0000FFFF;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1C00))->CRH |= 0xBBBB0000;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1C00))->CRL &= 0xFF000000;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1C00))->CRL |= 0x00BBBBBB;
	
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2000))->CRH &= 0xFFFFF0FF;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2000))->CRH |= 0x00000B00;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2000))->CRL &= 0xFF000000;
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2000))->CRL |= 0x00BBBBBB;
	
	
	
	
	((FSMC_Bank1_TypeDef *) (((u32)0xA0000000) + 0x0000))->BTCR[4] = 0x00000000;
	((FSMC_Bank1_TypeDef *) (((u32)0xA0000000) + 0x0000))->BTCR[5] = 0x00000000;
	((FSMC_Bank1E_TypeDef *) (((u32)0xA0000000) + 0x0104))->BWTR[4] = 0x00000000;
	
	
	
	
	((FSMC_Bank1_TypeDef *) (((u32)0xA0000000) + 0x0000))->BTCR[4] |= 1<< 14;
	((FSMC_Bank1_TypeDef *) (((u32)0xA0000000) + 0x0000))->BTCR[4] |= 1<< 12;			
	((FSMC_Bank1_TypeDef *) (((u32)0xA0000000) + 0x0000))->BTCR[4] |= 1<< 4;				
	((FSMC_Bank1_TypeDef *) (((u32)0xA0000000) + 0x0000))->BTCR[4] |= 0<< 2;
	...
	((FSMC_Bank1_TypeDef *) (((u32)0xA0000000) + 0x0000))->BTCR[5] |= 0<<28;
	((FSMC_Bank1_TypeDef *) (((u32)0xA0000000) + 0x0000))->BTCR[5] |= 0x2<<8;			
	((FSMC_Bank1_TypeDef *) (((u32)0xA0000000) + 0x0000))->BTCR[5] |= 1<<0;				
	
	((FSMC_Bank1E_TypeDef *) (((u32)0xA0000000) + 0x0104))->BWTR[4] |= 3<<8;
	
	((FSMC_Bank1_TypeDef *) (((u32)0xA0000000) + 0x0000))->BTCR[4] |= 1<<0;
}
