...
#line 5 "devices\\dma.c"

extern u16 FlappyBird_Frame[480][320];

u32 DMA1_MEM_LEN = (u32)(480*320/4);
...
void DMA_Init(void)
{
	...
	((RCC_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x1000))->AHBENR |= 1<<1;
	
	_delay_ms(5);
	
	
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CPAR = (u32)FlappyBird_Frame;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CMAR =(u32)0X6C000800;
	
	
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR = 0x00000000;
	...
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 0<<4;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 0<<5;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 1<<6;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 0<<7;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 1<<8;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 1<<10;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 1<<12;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 1<<14;
...
void DMA_LCD(void)
{
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR &= ~(1<<0);
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CPAR = (u32)FlappyBird_Frame[160];
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CNDTR = 153600;
	printf("| LEN = %ld|\r\n",DMA2_LCD_LEN);
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 1<<0;
	printf("| DMA2_Channel5 = %ld|\r\n",((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CNDTR);
	while(((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CNDTR != 0)
		printf("| DMA2_Channel5 = %ld|\r\n",((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CNDTR);
}
...
void DMA_Enable(void)
{
	...
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CPAR = (u32)FlappyBird_Frame[0];
	
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CNDTR = DMA1_MEM_LEN;
	...
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CPAR = (u32)FlappyBird_Frame[120];
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR &= ~(1<<0);
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CNDTR = DMA1_MEM_LEN;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 1<<0;
	...
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CPAR = (u32)FlappyBird_Frame[240];
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR &= ~(1<<0);
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CNDTR = DMA1_MEM_LEN;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 1<<0;
	...
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CPAR = (u32)FlappyBird_Frame[360];
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR &= ~(1<<0);
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CNDTR = DMA1_MEM_LEN;
	((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0458))->CCR |= 1<<0;
